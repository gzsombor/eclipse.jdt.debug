...
public final class StackFramePresentationProvider implements IPropertyChangeListener {
	...
	private static final Set<String> JAR_ICON = Set.of(JDIDebugModel.CATEGORY_LIBRARY.name(), JDIDebugModel.CATEGORY_SYNTHETIC.name(), JDIDebugModel.CATEGORY_PLATFORM.name());

	private final static Map<Category, String> fgKeyMap = Map.of(
			JDIDebugModel.CATEGORY_CUSTOM_FILTERED, IJDIPreferencesConstants.PREF_CUSTOM_FILTERED_STACK_FRAME_FG_COLOR, //
			JDIDebugModel.CATEGORY_SYNTHETIC, IJDIPreferencesConstants.PREF_SYNT_STACK_FRAME_FG_COLOR, //
			JDIDebugModel.CATEGORY_PLATFORM, IJDIPreferencesConstants.PREF_PLATFORM_STACK_FRAME_FG_COLOR, //
			JDIDebugModel.CATEGORY_TEST, IJDIPreferencesConstants.PREF_TEST_STACK_FRAME_FG_COLOR, //
			JDIDebugModel.CATEGORY_PRODUCTION, IJDIPreferencesConstants.PREF_PRODUCTION_STACK_FRAME_FG_COLOR, //
			JDIDebugModel.CATEGORY_LIBRARY, IJDIPreferencesConstants.PREF_LIB_STACK_FRAME_FG_COLOR
	);

	private final static Map<Category, String> bgKeyMap = Map.of(
			JDIDebugModel.CATEGORY_CUSTOM_FILTERED, IJDIPreferencesConstants.PREF_CUSTOM_FILTERED_STACK_FRAME_BG_COLOR, //
			JDIDebugModel.CATEGORY_SYNTHETIC, IJDIPreferencesConstants.PREF_SYNT_STACK_FRAME_BG_COLOR, //
			JDIDebugModel.CATEGORY_PLATFORM, IJDIPreferencesConstants.PREF_PLATFORM_STACK_FRAME_BG_COLOR, //
			JDIDebugModel.CATEGORY_TEST, IJDIPreferencesConstants.PREF_TEST_STACK_FRAME_BG_COLOR, //
			JDIDebugModel.CATEGORY_PRODUCTION, IJDIPreferencesConstants.PREF_PRODUCTION_STACK_FRAME_BG_COLOR, //
			JDIDebugModel.CATEGORY_LIBRARY, IJDIPreferencesConstants.PREF_LIB_STACK_FRAME_BG_COLOR
	);
