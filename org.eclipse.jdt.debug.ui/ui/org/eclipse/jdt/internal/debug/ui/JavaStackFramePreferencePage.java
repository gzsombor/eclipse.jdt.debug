...
public class JavaStackFramePreferencePage extends PreferencePage implements IWorkbenchPreferencePage, IPropertyChangeListener {
	...
	private void createStepFilterPreferences(Composite parent) {
		...
		this.fEnableCustomButton = new CategoryButton(container, DebugUIMessages.JavaStackFramesPreferencePage_Filter_custom, categorizer, IJavaStackFrame.Category.CUSTOM_FILTERED, //
		...
		categoryButtons.add(new CategoryButton(container, DebugUIMessages.JavaStackFramesPreferencePage_Filter_synthetic, categorizer, IJavaStackFrame.Category.SYNTHETIC, null));

		this.fEnablePlatformButton = new CategoryButton(container, DebugUIMessages.JavaStackFramesPreferencePage_Filter_platform, categorizer, IJavaStackFrame.Category.PLATFORM, //
		...
		categoryButtons.add(new CategoryButton(container, DebugUIMessages.JavaStackFramesPreferencePage_Filter_test, categorizer, IJavaStackFrame.Category.TEST, null));
		categoryButtons.add(new CategoryButton(container, DebugUIMessages.JavaStackFramesPreferencePage_Filter_production, categorizer, IJavaStackFrame.Category.PRODUCTION, null));
		categoryButtons.add(new CategoryButton(container, DebugUIMessages.JavaStackFramesPreferencePage_Filter_library, categorizer, IJavaStackFrame.Category.LIBRARY, null));
