...
public class JavaStackFramePreferencePage extends PreferencePage implements IWorkbenchPreferencePage, IPropertyChangeListener {
	...
	public JavaStackFramePreferencePage() {
		...
		this.categorizer = JDIDebugPlugin.getDefault().getStackFrameCategorizer();
	...
	private void createStepFilterPreferences(Composite parent) {
		...
		this.fEnableCustomButton = new CategoryButton(container, DebugUIMessages.JavaStackFramesPreferencePage_Filter_custom, categorizer, JDIDebugModel.CATEGORY_CUSTOM_FILTERED, //
		...
		categoryButtons.add(new CategoryButton(container, DebugUIMessages.JavaStackFramesPreferencePage_Filter_synthetic, categorizer, JDIDebugModel.CATEGORY_SYNTHETIC, null));

		this.fEnablePlatformButton = new CategoryButton(container, DebugUIMessages.JavaStackFramesPreferencePage_Filter_platform, categorizer, JDIDebugModel.CATEGORY_PLATFORM, //
		...
		categoryButtons.add(new CategoryButton(container, DebugUIMessages.JavaStackFramesPreferencePage_Filter_test, categorizer, JDIDebugModel.CATEGORY_TEST, null));
		categoryButtons.add(new CategoryButton(container, DebugUIMessages.JavaStackFramesPreferencePage_Filter_production, categorizer, JDIDebugModel.CATEGORY_PRODUCTION, null));
		categoryButtons.add(new CategoryButton(container, DebugUIMessages.JavaStackFramesPreferencePage_Filter_library, categorizer, JDIDebugModel.CATEGORY_LIBRARY, null));
	...
	private void initList() {
		colors = List.of(
				new CategoryColors(JDIDebugModel.CATEGORY_CUSTOM_FILTERED, DebugUIMessages.JavaStackFramesPreferencePage_category_custom_filter), //
				new CategoryColors(JDIDebugModel.CATEGORY_SYNTHETIC, DebugUIMessages.JavaStackFramesPreferencePage_category_synthetic), //
				new CategoryColors(JDIDebugModel.CATEGORY_PLATFORM, DebugUIMessages.JavaStackFramesPreferencePage_category_platform), //
				new CategoryColors(JDIDebugModel.CATEGORY_TEST, DebugUIMessages.JavaStackFramesPreferencePage_category_test), //
				new CategoryColors(JDIDebugModel.CATEGORY_PRODUCTION, DebugUIMessages.JavaStackFramesPreferencePage_category_production), //
				new CategoryColors(JDIDebugModel.CATEGORY_LIBRARY, DebugUIMessages.JavaStackFramesPreferencePage_category_library) //
		);
